...
$btc = 600;
$guid = 'useripm';  // Blockchain account
$main_password = 'paswws'; // Blockchain passs
...
if (isset($_POST['bitcoin']))
{
    ...
    if ($page > 0) {
        ...
        $y = $_SESSION['USD_amount'];
            ...
            mysql_query($sql2);
            $messages = '<font color=green>Payment Completed!</font> => <a href="http://rdpstore.net">Go Back</a>';
...
<link href="favicon.ico" rel="icon"/>
<meta https-equiv="Content-Type" content="text/html; charset=iso-8859-1"><title>RDPSTORE.NET</title>
...
<body>
    ...
    <table width="760" border="0" 
      ...
      <tr>
      <p>&nbsp;</p>
            <p><img src="http://s17.postimg.org/av7ll4q97/perfect_money.png" width="100" height="100" border="0" />
  <form action="" id="fcaptcha" name="fcaptcha" method="post">
  <p><font color="orange">First please choose one of our exchangers by clicking on the buttons below :</p>
  <p><a href="http://pm2btc.me" class="exchanger" target="_blank"><font color="yellow">pm2btc.me</a>&nbsp;</font>&nbsp; </a>
  </p>

            <p>Put the amount of :</i> <span id="total_price"><font size="5"><font color=gren><b><?=$_SESSION['USD_amount']?> USD</font></b></font></span></p>
